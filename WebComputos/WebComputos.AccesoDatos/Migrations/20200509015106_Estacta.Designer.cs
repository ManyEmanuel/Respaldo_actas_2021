...
namespace WebComputos.AccesoDatos.Migrations
{
    ...
    [Migration("20200509015106_Estacta")]
    partial class Estacta
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebComputos.Models.TActas", b =>
                {
                    b.HasOne("WebComputos.Models.RecepcionDetalle", "Lrecdet")
                        .WithMany()
                        .HasForeignKey("IdRecepcionDet")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
